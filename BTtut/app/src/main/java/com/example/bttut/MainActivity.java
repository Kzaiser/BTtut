            ...
            if (action.equals(BluetoothAdapter.ACTION_SCAN_MODE_CHANGED)) {
                ...
                switch (mode) {
                    ...
                    case BluetoothAdapter.SCAN_MODE_NONE:
                        Log.d(TAG, "mBroadcastReceiver2: Discoverability Disabled. No longer able to receive connections.");
                        break;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothDevice.ACTION_BOND_STATE_CHANGED)) {
                ...
                if (mDevice.getBondState() == BluetoothDevice.BOND_BONDING) {
                    Log.d(TAG, "BroadReceiver: BOND_BONDING.");
                }
...
//        });
    ...
    /**
     * This methos id required for all devices running API23+
    ...
    public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
        ...
        // create the band.
        // Note: Requires 17+? I think this is JellyBean
